...
// SSSnackbar
#define COCOAPODS_POD_AVAILABLE_SSSnackbar
#define COCOAPODS_VERSION_MAJOR_SSSnackbar 1
#define COCOAPODS_VERSION_MINOR_SSSnackbar 0
#define COCOAPODS_VERSION_PATCH_SSSnackbar 0
